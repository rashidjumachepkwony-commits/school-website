...
const required = ['server.js','supabase/schema.sql','worker/src/db.js','worker/src/index.js','worker/src/routes/clerk.js','scripts/import-registers.mjs','clerk-dashboard.html','admin-academics.html','teacher-checkin.html','admin-students.html','admin-teachers.html'];
...
console.log('Project validation passed: local server, worker modules, register import script and Supabase tables are present; active server is MongoDB-free.');
