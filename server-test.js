...
// ============================================
// HOLIDAY ASSIGNMENTS SCHEMA & ROUTES - RENDER FIXED
// ============================================
...
// POST - Upload new assignment (RENDER COMPATIBLE)
app.post('/api/holiday-assignments', upload.single('file'), async (req, res) => {
    ...
    try {
        ...
        // FIX: Use filename with /uploads/ path
...
console.log('✅ Holiday Assignment routes loaded (Render compatible)');
// ============================================
// FILE UPLOAD SETUP - RENDER COMPATIBLE
// ============================================
const uploadDirs = ['./uploads'];
uploadDirs.forEach(dir => {
    if (!fs.existsSync(dir)) {
